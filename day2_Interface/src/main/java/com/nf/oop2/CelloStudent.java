...
public class CelloStudent extends Student {
    private String firstname;
    private String lastname;
    private int id;
    private String course;
    private int modules = 20;

    public CelloStudent(String firstname, String lastname, int id) {
    ...
    public boolean equals(Object o) {
        ...
        CelloStudent student = (CelloStudent) o;
