...
public class ViolineStudent extends Student {

    private String firstname;
    private String lastname;
    private int id;
    private String course;
    private int modules = 25;

    public ViolineStudent(String firstname, String lastname, int id) {
    ...
    public boolean equals(Object o) {
        ...
        ViolineStudent student = (ViolineStudent) o;
